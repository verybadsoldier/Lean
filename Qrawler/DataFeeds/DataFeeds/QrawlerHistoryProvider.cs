...
namespace QuantConnect.Lean.Engine.DataFeeds.Qrawler
{
    ...
    /// </summary>
    public class QrawlerHistoryProvider : SynchronizingHistoryProvider
    {
        ...
        public override IEnumerable<Slice> GetHistory(IEnumerable<HistoryRequest> requests, DateTimeZone sliceTimeZone)
        {
            ...
            {
                Subscription subscription = CreateSubscription(request, request.StartTimeUtc, request.EndTimeUtc);
        ...
        private Subscription CreateSubscription(HistoryRequest request, DateTime start, DateTime end)
        {
            ...
            var dataReader = new HistoricalStreamer(request);
            ...
            IEnumerator<BaseData> reader = CorporateEventEnumeratorFactory.CreateEnumerators(
                dataReader,
                config,
                _factorFileProvider,
                dataReader,
